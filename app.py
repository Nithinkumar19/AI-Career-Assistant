...
st.markdown("[Connect with me on LinkedIn](https://www.linkedin.com/in/nithin-kumar-k-935514258/)")
...
st.sidebar.markdown(
    ...
    <div style="padding:10px 0;">
        <a href="https://github.com/Nithinkumar19" target="_blank" style="text-decoration:none;">
            ⭐ on GitHub
        </a>
    </div>
    """,
